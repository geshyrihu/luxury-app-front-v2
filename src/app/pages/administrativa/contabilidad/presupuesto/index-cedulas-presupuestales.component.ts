...
@Component({
  selector: 'app-index-cedulas-presupuestales',
  templateUrl: './index-cedulas-presupuestales.component.html',
  standalone: true,
  imports: [
    ComponentsModule,
    RouterModule,
...
export default class IndexCedulasPresupuestalesComponent
